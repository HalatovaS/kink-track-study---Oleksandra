...
${FAL_DIR}/flreconstruct -i ${MY_DIR}/simu_Bi.brio -p ${CONF_FAL}/official-2.0.0.conf -o ${MY_DIR}/PTD_Bi.brio

${FAL_DIR}/flreconstruct -i ${MY_DIR}/PTD_Bi.brio -p ${MY_DIR}/reco.conf -o ${MY_DIR}/CM_reco_Bi.brio
